...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{no of coin tosses}}
\\
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\\
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{probability of getting heads}}
\\
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\gnumericPB{\centering}\gnumbox{1/2}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{probability of getting tails}}
\\
\hhline{|-|-|-|}
\end{longtable}
